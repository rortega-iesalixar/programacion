...
public class Ejer5 {
  public static void main(String[] args) {
    ...
    // resulte más fácil, las repeticiones de números capicúa se conservan; es decir, si en el array
    // x el número 505 se repite 3 veces, en el array devuelto también estará repetido 3 veces. Si
    // no existe ningún número capicúa en x, se devuelve un array con el número -1 como único
    // elemento.
  }
}
